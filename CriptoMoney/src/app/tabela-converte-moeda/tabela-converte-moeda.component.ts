...
@Component({
  selector: 'app-tabela-converte-moeda',
  templateUrl: './tabela-converte-moeda.component.html',
  styleUrls: ['./tabela-converte-moeda.component.css']
})


export class TabelaConverteMoedaComponent implements OnInit {
